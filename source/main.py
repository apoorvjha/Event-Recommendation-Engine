...
def orchestrator(context_words, query_word):
    ...
    try:
        vector_db = VectorDatabase(config["VECTOR_DB"], config["VECTOR_STORE_TABLE_NAME"])
...
if __name__ == '__main__':
    context_words = ["conference", "workshop", "seminar", "symposium", "summit", "expo","convention", "meetup", "networking", "webinar", "training", "retreat", "exhibition", "panel", "lecture", "forum", "showcase", "roundtable", "demo", "gala"]
    query_word = "learning"
